...
class analysis:
    ...
    def plotComparison(self):
        ...
        taxMeanE.to_csv(Path('temp/clean/e' + filename))
        taxMeanC.to_csv(Path('temp/clean/c' + filename))
        ...
        tradeMeanE.to_csv(Path('temp/clean/e' + filename))
        tradeMeanC.to_csv(Path('temp/clean/c' + filename))
    ...
    def __buildFilePath(self, isTax):
        filepath = 'temp/seed-' + str(self.seed)
        if isTax:
