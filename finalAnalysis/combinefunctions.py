...
class combine:
    ...
    def __clean_csv_helper(self, cTax, cTrade, rates):
        ...
        cTax.to_csv(Path('clean/c' + filename))       
        filename = str(rates[1]) + ".csv"
        cTrade.to_csv(Path('clean/c' + filename))
    ...
    def __get_plot_df(self):
        c30 = pd.read_csv('clean/c30.csv')
        c60 = pd.read_csv('clean/c60.csv')
        c120 = pd.read_csv('clean/c120.csv')
        c1_0 = pd.read_csv('clean/c1.csv')
        c2_5 = pd.read_csv('clean/c2.5.csv')
        c5_0 = pd.read_csv('clean/c5.csv')
